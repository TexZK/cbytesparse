...
When `reporting a bug <https://github.com/TexZK/cbytesparse/issues>`_ please include:
...
cbytesparse could always use more documentation, whether as part of the
official cbytesparse docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork `cbytesparse <https://github.com/TexZK/cbytesparse>`_
